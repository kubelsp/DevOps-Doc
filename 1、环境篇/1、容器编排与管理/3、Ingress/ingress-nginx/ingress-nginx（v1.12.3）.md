...
>
> chart version：4.12.3  （k8s：1.32、1.31、1.30、1.29、1.28）
>
...
helm pull ingress-nginx/ingress-nginx --version 4.12.3 --untar
```
...
ccr.ccs.tencentyun.com/huanghuanhui/ingress-nginx:v1.12.3
ccr.ccs.tencentyun.com/huanghuanhui/ingress-nginx:kube-webhook-certgen-v1.5.4
ccr.ccs.tencentyun.com/huanghuanhui/ingress-nginx:defaultbackend-amd64-1.5
````
  ...
  admissionWebhooks: # 强烈建议开启 admission webhook
    ...
    patch:
      ...
      image:
        registry: ccr.ccs.tencentyun.com/huanghuanhui
        image: ingress-nginx
        tag: kube-webhook-certgen-v1.5.4
        digest:
        pullPolicy: IfNotPresent
